	...
	: qtractorScrollView(pParent)
{
	...
	m_pVzoomIn->setIcon(QIcon(":/icons/viewZoomIn.png"));
	m_pVzoomOut->setIcon(QIcon(":/icons/viewZoomOut.png"));
	m_pVzoomReset->setIcon(QIcon(":/icons/viewZoomTool.png"));
...
void qtractorMidiEditView::keyPressEvent ( QKeyEvent *pKeyEvent )
{
	...
	case Qt::Key_Home:
		if (pKeyEvent->modifiers() & Qt::ControlModifier) {
			...
			qtractorScrollView::setContentsPos(0, qtractorScrollView::contentsY());
		}
		break;
	case Qt::Key_End:
		if (pKeyEvent->modifiers() & Qt::ControlModifier) {
			qtractorScrollView::setContentsPos(
				qtractorScrollView::contentsWidth()  - qtractorScrollView::width(),
				qtractorScrollView::contentsHeight() - qtractorScrollView::height());
		} else {
			qtractorScrollView::setContentsPos(
				qtractorScrollView::contentsWidth()  - qtractorScrollView::width(),
				qtractorScrollView::contentsY());
...
void qtractorMidiEditView::mousePressEvent ( QMouseEvent *pMouseEvent )
{
	...
	// Only the left-mouse-button is meaningful for now...
