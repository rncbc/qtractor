...
#ifndef __qtractorCoreAudioEngine_h
#define __qtractorCoreAudioEngine_h
...
//----------------------------------------------------------------------
// class qtractorCoreAudioEngineProxy -- CoreAudio engine event proxy object.
//

class qtractorCoreAudioEngineProxy : public QObject
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	qtractorCoreAudioEngineProxy(QObject *pParent = nullptr)
		: QObject(pParent) {}
...
class qtractorCoreAudioEngine : public qtractorEngine
{
public:

	// Constructor.
	qtractorCoreAudioEngine(qtractorSession *pSession);

	// Engine initialization.
	bool init();

	// Special event notifier proxy object.
	const qtractorCoreAudioEngineProxy *proxy() const;
	...
	AudioDeviceID coreAudioDevice() const;
	AudioUnit     audioUnit() const;
#endif
...
private:
	...
	// Special event notifier proxy object.
	qtractorCoreAudioEngineProxy m_proxy;

#ifdef __APPLE__
	// CoreAudio device instance variables.
	AudioDeviceID    m_coreAudioDevice;
...
#endif  // __qtractorCoreAudioEngine_h


// end of qtractorCoreAudioEngine.h
